    ...
    <div class="container">
      <div class="phone sociallogin">
        <div class="glplogo_reg">
          ...
          <div class="sociallogo_btn"><button><router-link to="/socialmedia/socialmedia_reg_touch_security" class="glplogo_reg_btn">Next <img class="glplogo_reg_btn_img" src="reg_next.png"/></router-link></button>
          </div>
        </div>
      </div>
    </div>
