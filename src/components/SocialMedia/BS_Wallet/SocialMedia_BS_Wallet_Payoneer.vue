        ...
        <div class="profile_phone">
            ...
            <div class="add_modal">
                ...
                <div class="paypal_brand_content">
                    <p>Login to your Payoneer Account</p>
                    ...
                    <div class="sociallogo_btn">
                        <router-link to="/socialmedia/bs_wallet/socialmedia_bs_wallet_payoneer_success"><button class="paypal_brand_btn">LINK</button></router-link>
                    </div>
                </div>
            </div>
        </div>
