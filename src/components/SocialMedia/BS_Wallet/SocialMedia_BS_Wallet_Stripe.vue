        ...
        <div class="profile_phone">
            ...
            <div class="add_modal">
                <div class="paypal_brand_img">
                    <img src="wallet/stripe_brand.png">
                </div>
                <div class="paypal_brand_content">
                    ...
                    <div class="sociallogo_btn">
                        <router-link to="/socialmedia/bs_wallet/socialmedia_bs_wallet_stripe_success"><button class="paypal_brand_btn">LINK</button></router-link>
                    </div>
                </div>
            </div>
        </div>
