    ...
    <div class="container">
        <div class="phone header_phone">
          <div class="header_modal">
            <router-link to="/usercenter/upgrade_gs_account" class="header_arrow"><img src="img/header_arrow.png"></router-link>
            <a>SECURE CHECKOUT</a>
          </div>
          <div class="content left-content header_top">
            <p class="secure_checkout_title">Order Details</p>
            <p class="secure_checkout_desc">1-Year GOLD GS</p>
            <p class="secure_checkout_desc">Subtotal(USD)<span class="stage_right"><b>$99</b></span></p>
            <p class="secure_checkout_desc">Stage 2 Plan Option</p>

            <hr class="stage_date_money">
            <p class="stage_total">Subtotal(USD)<span class="stage_right"><b>$99</b></span></p>
