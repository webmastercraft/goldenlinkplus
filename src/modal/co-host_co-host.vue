          ...
          >
              ...
              <div v-for="(item, index) in viewdata" :key="index">
                ...
                <div class="view_profile_title">
                  ...
                  <p class="view_followers"><img src="view_star.png">Co-host of this Event</p>
  ...
  export default {
    ...
    data () {
      return {
        ...
        viewdata: [
          {
            user_img: "view_user.png",
            follow: true,
            name: "Ana Smith",
            coin_followers: "6.3k",
            coin_following: "1.2k",
            front_name: "Chief Executive Office",
            last_name: "APPLESEED Corporation",
          }
        ],
